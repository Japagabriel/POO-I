...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar(
            title: Center(child: Text("Atividade 8"),),
          ),
          body: Center(
              child: Column(
                    ...
                    switch (value['status']) {
                      case TableStatus.idle:
                        return const Row(
                            ...
                            children: [
                              Text(
                                "Bem vindo(a), Pressione um dos ícones abaixo!",
  ...
  Widget build(BuildContext context) {
    ...
    return BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(label: "Natural", icon: Icon(Icons.emoji_nature_outlined))
        ]);
  }
}
